...
const HeroBanner1 = () => {
    ...
    useEffect(() => {
      ...
      const heroContent = {
        ...
        title:'think digital',
        content:'We specialize in Social Media Marketing (SMM), Search Engine Marketing (SEM), Search Engine Optimization (SEO), and Public Relations (PR) to ensure that your business stands out in the digital landscape.',
        content2:"At CMT AI, we don't just offer services; we deliver results. Our team of experts leverages AI-powered insights and data-driven strategies to maximize your brands potential..",
        img:'/assets/img/hero/hero-text.png',   
        reviewlogo:'/assets/img/hero/logo.png',   
        reviewimg:'/assets/img/logo/logo white.svg',   
        review:'1k+ reviews',             
      }
            ...
            <div className="row g-4 align-items-center">
                ...
                <div className="col-xl-4 col-lg-6">
                    <div className="hero-image">
                        <img src="/assets/img/hero/hero-image.png" alt="img" className=" wow img-custom-anim-left" data-wow-duration="1.5s" data-wow-delay="0.3s"  style={{height:"400px"}}/>
                    ...
                    <div className="video-right">
                        ...
                        <div className="client-items wow fadeInUp" data-wow-delay=".7s">
                            ...
                            <div className="client-img">
                                <img src={heroContent.reviewimg} alt="img" style={{height:"20px"}}/>
