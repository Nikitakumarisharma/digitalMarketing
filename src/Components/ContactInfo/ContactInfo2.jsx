                    ...
                    <div className="row g-4 align-items-center">
                        ...
                        <div className="col-lg-6">
                            <div className="contact-content">
                                ...
                                <iframe width="600" height="500" src="https://crm.cmtai.cloud/forms/wtl/10722ba8db4b4abc95726faf62d04f4e" frameborder="0" sandbox="allow-top-navigation allow-forms allow-scripts allow-same-origin allow-popups" allowfullscreen></iframe>
                            </div>
                        </div>
                    </div>
                </div>
