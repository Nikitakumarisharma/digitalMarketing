...
const WhyChoose1 = () => {
    ...
    const chooseContent = {  
        subtitle:"More engagement, more success!",
        title:'From hashtags to headlines-we make you famous!',
        content:'A strong social media presence isn’t just about posting regularly-it’s about posting the right content at the right time! Our experts at CMT AI curate content that is visually appealing, highly engaging, and perfectly aligned with your brand voice.',  
        img:'/assets/img/team/01.png',         
        list1:'Pay as You Go Plans', 
        list2:'Custom Strategies For Every Brand', 
        list3:'Content Calender', 
        list4:'24/7 Response System', 
      }  

    return (
<section className="team-section fix py-5">
